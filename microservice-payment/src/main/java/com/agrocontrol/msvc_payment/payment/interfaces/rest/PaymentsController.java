package com.agrocontrol.msvc_payment.payment.interfaces.rest;
...
import com.agrocontrol.msvc_payment.payment.domain.services.PaymentCommandService;
...
import com.agrocontrol.msvc_payment.payment.interfaces.rest.transform.CreatePaymentCommandFromResourceAssembler;
import com.agrocontrol.msvc_payment.payment.interfaces.rest.transform.PaymentResourceFromEntityAssembler;
...
public class PaymentsController {
  ...
  @PostMapping
    ...
    public ResponseEntity<PaymentResource> getPaymentBySubscriptionId(@PathVariable Long subscriptionId) {
        ...
        return payment.map(source -> new ResponseEntity<>(PaymentResourceFromEntityAssembler.toResourceFromEntity(source), OK)).orElseGet(()
                -> ResponseEntity.notFound().build());
    }
}
